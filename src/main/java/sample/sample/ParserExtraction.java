...
//	
   public static void main(final String[] args) throws IOException,SAXException, TikaException {
	   ParserExtraction pe = new ParserExtraction();
	   pe.parseToStringExample();
   }
	   public String parseToStringExample() throws IOException, SAXException, TikaException {
		    Tika tika = new Tika();
		    try (InputStream stream = ParserExtraction.class.getResourceAsStream("test.doc")) {
...
//        String filename = args[0];
        String filename = "\\\\global.scd.scania.com\\home\\Se\\080\\dmuhbr\\Desktop\\New folder\\test5.docx";
